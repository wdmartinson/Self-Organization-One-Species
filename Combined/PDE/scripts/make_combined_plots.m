...
data = 'OffsetRectanglesMelOnly'; % 'MelBox', 'OffsetRectanglesMelOnly'
...
%     load('../data/sims/MelBox/PDE_with_Simultaneous_Estimation_Optimal_Alpha.mat')
...
elseif n == 5 && strcmp(data, 'OffsetRectanglesMelOnly')
    ...
    load('../data/sims/OffsetRectanglesMelOnly/PDE_with_Simultaneous_Estimation_Optimal_Alpha.mat')
end
...
for i = 1:length(t_view)
    ...
    axis square
    saveas(fig1, ['../plots/EnsembleAverageABM-OffsetRectanglesMelOnly-Fittedc+-Ndarts=',num2str(Nvals(n)),'-t=',num2str(t(t_view(i)))], 'fig')
    ...
    axis square
    saveas(fig2, ['../plots/PDE-OffsetRectanglesMelOnly-Fittedc+-Ndarts=',num2str(Nvals(n)),'-t=',num2str(t(t_view(i)))], 'fig')
    ...
    axis square
    saveas(fig3, ['../plots/Error-OffsetRectanglesMelOnly-Fittedc+-Ndarts=',num2str(Nvals(n)),'-t=',num2str(t(t_view(i)))], 'fig')
...
box on;
grid on;
% saveas(fig4, ['../plots/TotalMass-OffsetRectanglesMelOnly-Ndarts=',num2str(Nvals(n))], 'fig');
saveas(fig4, '../plots/TotalMass-OffsetRectanglesMelOnly-All-Ndarts', 'fig');
...
box on;
grid on;
saveas(fig5, '../plots/RadiusOfSupport-OffsetRectanglesMelOnly-All-Ndarts', 'fig');
